...
public class tigerLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"IN", "OF", "THEN", "TO", "VAR", "WHILE", "ENDIF", "BEGIN", "END", "ENDDO", 
			"RETURN", "INT", "FLOAT", "ASSIGN", "LE", "GE", "NE", "LT", "GT", "EQ", 
			"PLUS", "MINUS", "MULT", "DIV", "AND", "OR", "COMMA", "COLON", "SEMICOLON", 
			"LPAREN", "RPAREN", "LBRACKET", "RBRACKET", "ID", "INTLIT", "FLOATLIT", 
			"COMMENT", "WS"
		};
	}
